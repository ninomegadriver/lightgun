;Opti-MAME extended mouse driver 
;Uses Cute Mouse Driver v1.6 code (c) 1997-1999 Nagy Daniel.
;Under permission for Opti-MAME use, thanks to Nagy Daniel.

;Please check ctmouse.asm for the original Cute Mouse driver

;Don't bug Nagy Daniel about this custom version of Cute Mouse
...
IFNDEF PS2
cutestring      db      'Opti-MAME extended mouse driver for a serial mouse.',0dh,0ah
                db      'Uses Cute Mouse Driver v1.6 (c) 1997-1999 Nagy Daniel.',0dh,0ah
                db      'Under permission for Opti-MAME use, thanks to Nagy Daniel.',0dh,0ah
                db      'Type optidrv /? for help',0dh,0ah,'$'
...
ELSE
cutestring      db      'Opti-MAME extended mouse driver for a PS/2 mouse.',0dh,0ah
                db      'Uses Cute Mouse Driver v1.6 (c) 1997-1999 Nagy Daniel.',0dh,0ah
                db      'Under permission for Opti-MAME use, thanks to Nagy Daniel.',0dh,0ah
                db      'Type optidrvp /? for help',0dh,0ah,'$'
...
ps2not          db      'Error: PS/2 not supported, use /x where x is a valid COM port',0dh,0ah,'$'
ELSE
