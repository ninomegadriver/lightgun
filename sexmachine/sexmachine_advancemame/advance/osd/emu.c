...
static void help(void)
{
	...
	target_out("%slistbare       output the rom XML file removing info not required by\n                 frontends\n", slash);
...
#else
	target_out("Example: %s lethalen\n", ADV_NAME);
#endif
	target_out("\n");
#if !defined(__MSDOS__) && !defined(__WIN32__)
	target_out("To get help type 'man %s'.\n", ADV_NAME);
#ifdef ADV_DATADIR
	target_out("Extensive documentation is located at:\n'%s'\n", ADV_DATADIR "/doc");
#endif
	target_out("\n");
#endif
}
...
// [SEXMACHINE] Custom Game Configurations
void sexmachine_minmax(){
		if (strstr(game_name, "alien3") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "area51") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "bang") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "bbusters") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
			tune_y = -5;
		} else if (strstr(game_name, "borntofi") != NULL) {
			game_min_x = 0x00;
			game_max_x = 0xff;
			game_min_y = 0x80;
			game_max_y = 0xff;
		} else if (strstr(game_name, "carnevil") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "catch22") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "cheyenne") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "chiller") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "claypign") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "combat") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "cracksht") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "critcrsh") != NULL) {
			game_min_x = 0;
			game_max_x = 0x3f;
			game_min_y = 0x0;
			game_max_y = 0x3f;
		} else if (strstr(game_name, "crossbow") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "cyclshtg") != NULL) {
			game_min_x = 0x00;
			game_max_x = 0xff;
			game_min_y = 0x00;
			game_max_y = 0xff;
		} else if (strstr(game_name, "desertgu") != NULL) {
			game_min_x = 0xf;
			game_max_x = 0x7f;
			game_min_y = 0xf;
			game_max_y = 0x7f;
		} else if (strstr(game_name, "dragngun") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "duckhunt") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
			tune_y = -15;
		} else if (strstr(game_name, "eggventr") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "eggvntdx") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "gdfs") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "ghlpanic") != NULL) {
			game_min_x = 0xc0;
			game_max_x = 0x35f;
			game_min_y = 0x1a;
			game_max_y = 0x109;
		} else if (strstr(game_name, "ghoshunt") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "golgo13") != NULL) {
			game_min_x = 0x9c;
			game_max_x = 0x29b;
			game_min_y = 0x1f;
			game_max_y = 0x1de;
		} else if (strstr(game_name, "gollygho") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "greatgun") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "gunbulet") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "gunbustr") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "hitnmiss") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "hogalley") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "jpark") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "kdeadeye") != NULL) {
			game_min_x =  0x004c;
			game_max_x =  0x01bb ;
			game_min_y =  0x0000;
			game_max_y =  0x00ef ;
		} else if (strstr(game_name, "konamigq") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "le2") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "lethalen") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "lethalj") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "lghost") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "lockload") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "loffire") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "lordgun") != NULL) {
			game_min_x = 0;
			game_max_x = 0x1ff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "lostwsga") != NULL) {
			game_min_x = 0x00;
			game_max_x = 0x3ff;
			game_min_y = 0x00;
			game_max_y = 0x3ff;
		} else if (strstr(game_name, "luckywld") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "mazerbla") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "mechatt") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "nycaptor") != NULL) {
			game_min_x = 0x00;
			game_max_x = 0xff;
			game_min_y = 0x00;
			game_max_y = 0xff;
			tune_y = -5;
		} else if (strstr(game_name, "oneshot") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "opwolf") != NULL) {
			game_min_x = 0x00;
			game_max_x = 0xff;
			game_min_y = 0x00;
			game_max_y = 0xff;
			tune_y = -5;
		} else if (strstr(game_name, "opwolf3") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "othundrj") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "playc10g") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "pntnpuzl") != NULL) {
			game_min_x = 0;
			game_max_x = 0x7f;
			game_min_y = 0;
			game_max_y = 0x7f;
		} else if (strstr(game_name, "policetr") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "ptblank2") != NULL) {
			game_min_x = 0xd8;
			game_max_x = 0x387;
			game_min_y = 0x2c;
			game_max_y = 0x11b;
		} else if (strstr(game_name, "ptblnk2a") != NULL) {
			game_min_x = 0xd8;
			game_max_x = 0x387;
			game_min_y = 0x2c;
			game_max_y = 0x11b;
		} else if (strstr(game_name, "rchase") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "revx") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "sgunner") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "showdown") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "spacegun") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "targeth") != NULL) {
			game_min_x =  0;
			game_max_x =  400 + 4;
			game_min_y = 4;
			game_max_y = 255;
		} else if (strstr(game_name, "tickee") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "timecris") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "triplhnt") != NULL) {
			game_min_x = 0x00;
			game_max_x = 0xff;
			game_min_y = 0x00;
			game_max_y = 0xef;
		} else if (strstr(game_name, "tshoot") != NULL) {
			game_min_x = 0;
			game_max_x = 0x3F;
			game_min_y = 0;
			game_max_y = 0x3F;
		} else if (strstr(game_name, "undrfire") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "vsfdf") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "vsgshoe") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "whodunit") != NULL) {
			game_min_x = 0;
			game_max_x = 255;
			game_min_y = 0;
			game_max_y = 255;
		} else if (strstr(game_name, "wildplt") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "zeropnt") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "zeropnt2") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
		} else if (strstr(game_name, "zombraid") != NULL) {
			game_min_x = 0;
			game_max_x = 0xff;
			game_min_y = 0;
			game_max_y = 0xff;
...
int os_main(int argc, char* argv[])
{
	...
	if (access(file_config_file_home(ADV_NAME ".rc"), F_OK) != 0) {
		...
		target_err("\nConfiguration file created with all the default options:\n%s\n", file_config_file_home(ADV_NAME ".rc"));
...
#else
		target_err("The default rom search path is:\n%s.\n"
			"You can change it using the `dir_rom' option in the\nconfiguration file.\n",
